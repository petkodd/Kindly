...
export const metadata: Metadata = buildMetadata({
  title: 'Join the Dearly Waitlist — AI Companion for Aging Parents',
  description:
  ...
  return (
    <section className="container-k py-20">
      ...
      <h1 className="mt-4 font-display text-3xl font-semibold text-ink md:text-4xl">
        Join the Dearly waitlist
      </h1>
      <p className="mt-6 max-w-2xl text-lg text-muted">
        Be among the first families to try Dearly. We’ll let you know the moment early access opens,
